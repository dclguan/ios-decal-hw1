...
//: They aren't the same type - **!** variables are implicitly unwrapped optionals that are **nil** initially, but shouldn't be in the future. **?** variables are allowed to be **nil** and can be tested for.
